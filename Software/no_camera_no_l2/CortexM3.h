...
/*-------------Camera------------*/
typedef struct{
    __IO    uint32_t    CAMERA_VALUE[240][320];       /*!< Offset: 0x60040000 Camera Value Ram                    */
            uint32_t    reserved_camera[5120];        /*!< Offset: 0x6008b000 Reserved                            */
    __IO    uint32_t    CAMERA_RST;                   /*!< Offset: 0x60090000 Camera Reset Register               */
    __IO    uint32_t    CAMERA_PWDN;                  /*!< Offset: 0x60090004 Camera PowerDown Register           */
    __IO    uint32_t    CAMERA_SCL;                   /*!< Offset: 0x60090008 Camera SCL Register                 */
    __IO    uint32_t    CAMERA_SDAO;                  /*!< Offset: 0x6009000C Camera SDA Write Register           */
    __IO    uint32_t    CAMERA_SDAI;                  /*!< Offset: 0x60090010 Camera SDA Read Register            */
    __IO    uint32_t    CAMERA_SDAOEN;                /*!< Offset: 0x60090014 Camera SDA Write Enable Register    */
    __IO    uint32_t    CAMERA_DATA_STATE;            /*!< Offset: 0x60090018 Camera Data State Register          */
    // __IO    uint32_t    CAMERA_DATA_LEN;              /*!< Offset: 0x6009001C Camera Data Length Register       */
}CAMERA_TypeDef;
...
#define RESIZER_BASE      (0x600A0000UL)

/* AHBL2 Peripherals */ 
#define CAMERA_BASE       (AHB_BASE)
//#define CAMERA_BASE       (0x4040AA00UL)
#define LCD_BASE          (AHB_BASE + 0x51000UL)
#define GPIO_BASE         (AHB_BASE + 0x52000UL)
