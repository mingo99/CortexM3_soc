...
typedef struct
{
    ...
    __IO    uint32_t    WMASKCODE_H;            /*!< Offset: 0x60030020 Weight Mask Code Higher Register            */
    __IO    uint32_t    WMASKCODE_L;            /*!< Offset: 0x60030024 Weight Mask Code Lower Register             */
    __IO    uint32_t    WMASKCODEN_H;           /*!< Offset: 0x60030028 Auxiliary Weight Mask Code Higher Register  */
    __IO    uint32_t    WMASKCODEN_L;           /*!< Offset: 0x6003002C AuxiliaryWeight Mask Code Lower Register    */
            uint32_t    Reserverd[4];
    __I     uint32_t    ISVALID;                /*!< Offset: 0x60030040 Whether Results is Valid Register           */     
    __I     uint32_t    CATEGORY;               /*!< Offset: 0x60030044 Mask Wear Information Register              */    
    __I     uint32_t    FACECOORD[5][2];        /*!< Offset: 0x60030048 Face Box Position Register                  */
...
extern void ACC_RegCfg(const uint32_t *regval);
