...
#
# Generated by export_simulation on Wed Oct 20 12:05:50 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './subtracter_16bit.sh' script.

./subtracter_16bit.sh -reset_run
...
./subtracter_16bit.sh -noclean_files

For more information on the script, please type './subtracter_16bit.sh -help'.
