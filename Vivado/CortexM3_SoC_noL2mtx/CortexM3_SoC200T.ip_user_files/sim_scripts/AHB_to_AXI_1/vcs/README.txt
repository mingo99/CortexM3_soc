...
#
# Generated by export_simulation on Wed Oct 20 12:06:22 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './AHB_to_AXI.sh' script.

./AHB_to_AXI.sh -reset_run
...
./AHB_to_AXI.sh -noclean_files

For more information on the script, please type './AHB_to_AXI.sh -help'.
