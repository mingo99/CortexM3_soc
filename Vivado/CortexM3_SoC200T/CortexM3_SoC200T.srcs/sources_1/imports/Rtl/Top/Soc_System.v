...
cmsdk_ahb_to_ahb_apb_async #(
    ...
    .HCLKS                   (clk),
    .HRESETSn                (cpuresetn),
    .HSELAHBS                (HSEL_AHBL1_AHBAsync),
    .HSELAPBS                (1'b0),
    .HADDRS                  (HADDR_AHBL1_AHBAsync),
    .HTRANSS                 (HTRANS_AHBL1_AHBAsync),
    .HWRITES                 (HWRITE_AHBL1_AHBAsync),
    .HSIZES                  (HSIZE_AHBL1_AHBAsync),
    .HBURSTS                 (HBURST_AHBL1_AHBAsync),
    .HPROTS                  (HPROT_AHBL1_AHBAsync),
    .HMASTERS                (HMASTER_AHBL1_AHBAsync),
    .HWDATAS                 (HWDATA_AHBL1_AHBAsync),
    //.HMASTLOCKS              (HMASTLOCK_AHBL1_AHBAsync),
    .HREADYS                 (HREADY_AHBL1_AHBAsync),
    .HRDATAS                 (HRDATA_AHBL1_AHBAsync),
    .HREADYOUTS              (HREADYOUT_AHBL1_AHBAsync),
    .HRESPS                  (HRESP_AHBL1_AHBAsync),

    .HCLKM                   (clk_ddr),
    .HRESETMn                (cpuresetn),
    .HADDRM                  (HADDR_AHB_DDR),
    .HBURSTM                 (HBURST_AHB_DDR),
    .HMASTLOCKM              (HMASTLOCK_AHB_DDR),
    .HPROTM                  (HPROT_AHB_DDR),
    .HSIZEM                  (HSIZE_AHB_DDR),
    .HTRANSM                 (HTRANS_AHB_DDR),
    .HWDATAM                 (HWDATA_AHB_DDR),
    .HWRITEM                 (HWRITE_AHB_DDR),
    .HMASTERM                (HMASTER_AHB_DDR),
    .HRDATAM                 (HRDATA_AHB_DDR),
    .HREADYM                 (HREADY_AHB_DDR),
    .HRESPM                  (HRESP_AHB_DDR),
    .HACTIVEM                (HACTIVE_AHB_DDR),
...
//------------------------------------------------------------------------------
// AHBL1 DEFAULT SLAVE RESERVED FOR DMAC
//------------------------------------------------------------------------------
...
assign  IRQ    =   {229'b0, acc_INT, DMA_Event, uart_INT, key_INT};
//assign  IRQ    =   {234'b0,acc_INT,uart_INT};
