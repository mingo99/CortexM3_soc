...
assign  tens_done   =   value_tens == 4'h9;
assign  hund_done   =   value_hund == 4'h9;
assign  thsd_done   =   value_thsd == 4'h9;
...
assign seg          =   dig     ==  6'b111101                 ?   (
                        value_show  ==  4'h0    ?   8'b10111111   :   (
                        value_show  ==  4'h1    ?   8'b10000110   :   (
                        value_show  ==  4'h2    ?   8'b11011011   :   (
                        value_show  ==  4'h3    ?   8'b11001111   :   (
                        value_show  ==  4'h4    ?   8'b11100110   :   (
                        value_show  ==  4'h5    ?   8'b11101101   :   (
                        value_show  ==  4'h6    ?   8'b11111101   :   (
                        value_show  ==  4'h7    ?   8'b10000111   :   (
                        value_show  ==  4'h8    ?   8'b11111111   :   (
                        value_show  ==  4'h9    ?   8'b11101111   :   8'b10000000)))))))))
                        ):(  
                        value_show  ==  4'h0    ?   8'b00111111   :   (
