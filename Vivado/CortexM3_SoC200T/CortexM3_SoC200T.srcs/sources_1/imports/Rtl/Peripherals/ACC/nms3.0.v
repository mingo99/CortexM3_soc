...
begin
    case(s_addr1)
        8'h30: final_result={27'b0,is_valid4,is_valid3,is_valid2,is_valid1,is_valid0};
        8'h34: final_result={27'b0,category4,category3,category2,category1,category0};
        8'h38: final_result={real_xmin0,real_ymin0};
        8'h3C: final_result={real_xmax0,real_ymax0};
        8'h40: final_result={real_xmin1,real_ymin1};
        8'h44: final_result={real_xmax1,real_ymax1};
        8'h48: final_result={real_xmin2,real_ymin2};
        8'h4C: final_result={real_xmax2,real_ymax2};
        8'h50: final_result={real_xmin3,real_ymin3};
        8'h54: final_result={real_xmax3,real_ymax3};
        8'h58: final_result={real_xmin4,real_ymin4};
        8'h5C: final_result={real_xmax4,real_ymax4};        
